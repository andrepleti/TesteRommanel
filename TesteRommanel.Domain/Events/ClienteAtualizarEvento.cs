...
{
    public class ClienteAtualizarEvento(string nomeRazaoSocial, string cpfCnpj, string inscricaoEstadual, bool isento, DateTime? dataNascimento, string telefone, string email, byte tipo,
           string cep, string logradouro, string numero, string bairro, string cidade, string estado, long id) : IEvento
    {
