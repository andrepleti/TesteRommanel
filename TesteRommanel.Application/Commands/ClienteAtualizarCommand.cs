...
namespace TesteRommanel.Application.Commands
{
    public class ClienteAtualizarCommand
    {
        ...
        public ClienteAtualizarCommand(long id, string nomeRazaoSocial, string cpfCnpj, string inscricaoEstadual, bool isento, DateTime? dataNascimento, string telefone, string email, byte tipo,
